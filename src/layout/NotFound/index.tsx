...
import { Home, LogIn, Star, Heart, Zap } from 'lucide-react';
      ...
      <div className="relative w-[1280px] h-[720px] bg-black/80 rounded-3xl shadow-2xl overflow-hidden flex items-center justify-center">
        ...
        <div className="text-center max-w-2xl mx-auto relative z-10 text-white px-8">
          ...
          <div className="mb-8 relative">
            ...
            <div className="absolute inset-0 text-[12rem] font-black text-purple-300/20 animate-ping">404</div>
          </div>
          ...
          <div className="space-y-6 backdrop-blur-sm bg-white/5 rounded-3xl p-8 border border-white/10 shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              ...
              <Link
                to="/login"
                className="group relative px-8 py-4 border-2 border-blue-400 text-blue-300 font-semibold rounded-full hover:bg-blue-500 hover:text-white transition-all duration-300 hover:scale-105 hover:border-blue-300 focus:outline-none focus:ring-4 focus:ring-blue-500/50"
              >
                <div className="flex items-center gap-2">
