...
const GewogManagement = () => {
  ...
  return (
    <div className="p-6 space-y-6 bg-purple-300"> {/* Added light green background */}
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="flex gap-4 items-center w-full md:w-auto">
          ...
          <select
            ...
            className="border px-4 py-2 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-500"
          >
      ...
      {/* Updated Grid with Responsive Design and Hover Effects */}
